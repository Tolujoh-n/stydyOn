# Generated by Django 2.2 on 2022-12-24 22:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studyonline.Course')),
            ],
        ),
        migrations.CreateModel(
            name='Learner',
        ...
        migrations.AddField(
            model_name='course',
            name='instructors',
            field=models.ManyToManyField(to='studyonline.Instructor'),
        ),
        migrations.AddField(
            model_name='course',
            name='users',
            field=models.ManyToManyField(through='studyonline.Enrollment', to=settings.AUTH_USER_MODEL),
        ),
    ]
